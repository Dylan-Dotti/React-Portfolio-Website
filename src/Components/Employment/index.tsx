...
const Employment: React.FC = () => {
    ...
    return (
        <div id="employment">
            <ScrollFadeInSection durationMS={appConstants.fadeInDurationMS} className="title-group content-container">
                <h1 className="text-center">Employment</h1>
                <hr className="half-centered"/>
            </ScrollFadeInSection>
                
            <ScrollFadeInSection durationMS={appConstants.fadeInDurationMS} className="software-engineer-group content-container">
            ...
            <ScrollFadeInSection durationMS={appConstants.fadeInDurationMS} className="ghd-engineer-group content-container">
